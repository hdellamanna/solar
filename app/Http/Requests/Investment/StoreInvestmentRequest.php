...
/**
 * Validation rules for creating a new investment.
 *
 * Amounts come in as decimal numbers (e.g. `10.50`, `0.05`) and are
 * converted to cents in the controller — same convention as Account
 * and Subscription.
 */
