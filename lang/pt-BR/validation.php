...
/*
| FASE 7 — i18n tri-língue: Portuguese (Brazil) validation messages.
| Mirrors the standard Laravel validation message set translated,
| plus the project's custom rules.
*/
...
$base = [
    ...
    // Project-specific custom rules (used by FormRequest::messages()
    // and the inline `messages()` overrides; mirrored in es / en).
    'category_name_pt_required' => 'O nome em português é obrigatório.',
    'tag_slug_unique' => 'Esta tag já existe.',

    'custom' => [
        'attribute-name' => [
            'rule-name' => 'mensagem-custom',
        ],
    ],
